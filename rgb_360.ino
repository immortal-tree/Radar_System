...
const int trigPin1 = 6; // Trig pin for sensor 1
const int echoPin1 = 5; // Echo pin for sensor 1
const int trigPin2 = 7; // Trig pin for sensor 2
...
void loop() {
  ...
  for (int angle = 0; angle <= 180; angle += 2) {
    ...
    // Choose the minimum distance detected
